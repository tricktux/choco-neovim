...
$url64       = 'https://github.com/neovim/neovim/releases/download/v0.11.7/nvim-win64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
$bin         = $destDir + '\nvim-win64\bin'
...
$packageArgs = @{
    ...
    checksum64    = '7b10e6e08b14bf256422b72cfe706ef0452fd9c0a40e138426e1af09803d697f'
